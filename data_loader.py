...
def csv_to_json(filename):
    data = pd.read_csv(filename, error_bad_lines=False, usecols=[
        "video_id", "publish_time", "trending_date", "title", "channel_title", "category_id", "views", "likes", "dislikes", "comment_count"
    ], encoding="utf-8")
